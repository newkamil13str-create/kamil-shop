...
export default function LoginUser() {
  const handleLogin = (e) => {
    e.preventDefault();
    alert("Ini tampilan UI. Untuk fungsi asli, sambungkan ke Database/NextAuth!");
  };
    ...
    <>
      ...
      <div className="min-h-[80vh] flex items-center justify-center bg-gray-50 px-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          <h2 className="text-2xl font-bold text-center text-gray-800 mb-6">Login KAMIL SHOP</h2>
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button type="submit" className="w-full bg-blue-600 text-white py-2.5 rounded-lg font-semibold hover:bg-blue-700 transition">Masuk</button>
          </form>
